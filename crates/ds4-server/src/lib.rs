...
pub use render::{
    ...
    render_solar_chat, render_solar_chat_ex, role_is_system, role_is_user_like,
    syntax_for_model_id, think_effort_prefix, tool_start_marker, ModelSyntax, RenderError,
    DSML_ASSISTANT, DSML_BOS, DSML_EOS, DSML_USER, THINK_HIGH_PREFIX, THINK_MAX_PREFIX,
};
