...
help:
	...
	@echo "  make test-server-parity C↔Rust HTTP door + route_decide (Phase 7)"
...
test-route-parity: tests/parity/route_c_oracle tests/parity/server_c_oracle
